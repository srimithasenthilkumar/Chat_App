		...
		<div className="w-full min-h-32  shadow-gray-950 shadow-inner flex flex-col justify-between items-start px-4 py-8 bg-slate-800 text-white">
			...
			<div className="flex items-center justify-start w-full p-4 flex-wrap">
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>
						<Link
							to={"mailto:srimithasenthilkumar222@gmail.com"}
							target="_blank"
				...
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://www.linkedin.com/in/srimitha-s-5b470832b/"
							target="_blank"
							rel="noreferrer"
						>
							LinkedIn
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://github.com/srimithasenthilkumar"
							target="_blank"
							rel="noreferrer"
						>
							Github
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://www.instagram.com/srimitha_senthilkumar?igsh=aTJ4dnlka3Y4azA5"
							target="_blank"
							rel="noreferrer"
						>
							Instagram
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="mailto:srimithasenthilkumar222@gmail.com"
							target="_blank"
							rel="noreferrer"
						>
							E-Mail
